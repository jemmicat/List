...
#define HEATER_0_MAXTEMP 325 //{SD Patch}
...
#define EXTRUDE_MINTEMP 170 //{SD Patch}
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88,88,4000,394}  //{SD Patch} // default steps per unit for ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 10, 100}    //{SD Patch} // (mm/sec)
