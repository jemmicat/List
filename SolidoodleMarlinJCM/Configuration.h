...
#define HEATER_0_MAXTEMP 320	//{SD Patch}
...
#define EXTRUDE_MINTEMP 180	//{SD Patch}
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88,88,4000,394.13}  // default steps per unit for Ultimaker {SD Patch}
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 100}    // (mm/sec) {SD Patch}
